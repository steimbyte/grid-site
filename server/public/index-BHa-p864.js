var $=Object.defineProperty;var k=(m,e,t)=>e in m?$(m,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):m[e]=t;var b=(m,e,t)=>k(m,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();class C{static render(){return`
    ...
    `}static escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}}class q{constructor(e,t){b(this,"site");b(this,"onClose");this.site=e,this.onClose=t}open(){var a;const e=document.querySelector(".app-container");if(!e)return;const t=document.createElement("div");t.className="viewer-overlay",t.innerHTML=this.render(),e.appendChild(t),window.lucide&&window.lucide.createIcons();const i=document.getElementById("site-iframe"),s=document.getElementById("iframe-loader");if(i&&this.site.content){i.onload=()=>{s==null||s.classList.add("hidden"),i.classList.add("loaded");try{const r=i.contentDocument;r&&(r.documentElement.style.backgroundColor="#0a0a0f",r.body.style.backgroundColor="#0a0a0f")}catch{}};const n=getComputedStyle(document.documentElement).getPropertyValue("--bg-deep")||"#0a0a0f",g=getComputedStyle(document.documentElement).getPropertyValue("--accent")||"#c9a227",d=getComputedStyle(document.documentElement).getPropertyValue("--border-accent")||"#333";i.srcdoc=`<html><body style="background:${n};margin:0;display:flex;align-items:center;justify-content:center;height:100vh;">
    ...
    `}}class x{static render(e,t,i,s,a,n,g,d,r,l){return`
      <header class="header">
    ...
    `,document.body.appendChild(i);let s=[];try{const h=(await(await fetch("https://cdn.jsdelivr.net/npm/lucide@latest/dist/esm/lucide.js")).text()).matchAll(/export \{ default as ([A-Z][a-zA-Z]+)/g);for(const v of h){const p=v[1].replace(/([A-Z])/g,"-$1").toLowerCase().replace(/^-/,"");s.push(p)}}catch{s=["globe","file","image","code","link","star","heart"]}const a=document.getElementById("icon-grid"),n=document.getElementById("icon-search"),g=r=>{var h;const l=r?s.filter(v=>v.toLowerCase().includes(r.toLowerCase())):s.slice(0,200);a.innerHTML=l.slice(0,80).map(v=>`<button class="icon-option ${t.icon===v?"selected":""}" data-icon="${v}" title="${v}">
          <i data-lucide="${v}"></i>
        </button>`).join(""),(h=window.lucide)==null||h.createIcons()};g(""),a.addEventListener("click",async r=>{const l=r.target.closest(".icon-option");if(!l)return;const h=l.dataset.icon;try{await this.apiRequest(`${u}/sites/${e}`,{method:"PUT",body:JSON.stringify({icon:h})}),await this.loadSites(),this.render(),i.remove()}catch{alert("Icon update failed")}}),n.addEventListener("input",()=>g(n.value)),(d=document.getElementById("settings-close"))==null||d.addEventListener("click",()=>i.remove()),i.addEventListener("click",r=>{r.target===i&&i.remove()})}async handleView(e){if(this.session)try{const t=await this.apiRequest(`${u}/sites/${e}`);this.viewer=new q(t,()=>{this.viewer=null,this.render()}),this.viewer.open()}catch(t){console.error(t)}}}document.addEventListener("DOMContentLoaded",()=>new I);
