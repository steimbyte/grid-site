var w=Object.defineProperty;var f=(l,t,e)=>t in l?w(l,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[t]=e;var h=(l,t,e)=>f(l,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();class b{static render(){return`
    ...
    `}}class g{static render(t,e=!1){return t.length===0?`
    ...
    `}getFullUrl(){return`/sites/${this.site.id}`}escapeHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}}class L{static render(t,e,i){return`
      <header class="header">
        ...
        <div class="login-split">
          <div class="login-brand">
            <div class="brand-content">
              ...
              <h1>Site Grid</h1>
              <p>Manage and preview your HTML sites</p>
            </div>
          ...
          <div class="login-form-side">
            <div class="form-container">
              ...
              <div class="quick-actions">
                <button class="quick-btn" data-role="guest">
                  <span class="role-name">Guest</span>
                  <span class="role-desc">View & upload</span>
                </button>
                <button class="quick-btn" data-role="admin">
    ...
    `}static init(t){const e=document.getElementById("login-password"),i=document.getElementById("btn-login"),s=document.getElementById("login-error"),n=document.querySelectorAll(".quick-btn"),r=async c=>{if(!c.trim()){e.classList.add("error"),s.textContent="Please enter a password",s.classList.add("show"),setTimeout(()=>e.classList.remove("error"),500);return}i.classList.add("loading"),s.classList.remove("show"),await t(c),i.classList.remove("loading")};i==null||i.addEventListener("click",()=>r(e.value)),e==null||e.addEventListener("keydown",c=>{c.key==="Enter"&&r(e.value)}),e==null||e.addEventListener("input",()=>{s.classList.remove("show")}),n.forEach(c=>{c.addEventListener("click",()=>{const o=c.dataset.role;r(o)})})}}const y={accentColor:"#c9a227"};class v{static load(){const t=localStorage.getItem("site-grid-settings");return t?{...y,...JSON.parse(t)}:{...y}}static save(t){localStorage.setItem("site-grid-settings",JSON.stringify(t)),this.apply(t)}static apply(t){const e=t.accentColor.replace("#",""),i=parseInt(e.slice(0,2),16),s=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);document.documentElement.style.setProperty("--accent",t.accentColor),document.documentElement.style.setProperty("--glow",`rgba(${i}, ${s}, ${n}, 0.4)`);const r=Math.min(255,i+30),c=Math.max(0,s-50),o=Math.max(0,n-30);document.documentElement.style.setProperty("--accent-warm",`rgb(${r}, ${c}, ${o})`);const a=Math.max(0,i-100),d=Math.min(255,s+40),p=Math.min(255,n+20);document.documentElement.style.setProperty("--accent-sage",`rgb(${a}, ${d}, ${p})`),document.documentElement.style.setProperty("--bg-accent-tint",`rgba(${i}, ${s}, ${n}, 0.05)`),document.documentElement.style.setProperty("--glass-tint",`rgba(${i}, ${s}, ${n}, 0.08)`),document.documentElement.style.setProperty("--border-accent",`rgba(${i}, ${s}, ${n}, 0.3)`)}static render(t){return`
    ...
    `}static init(t){const e=document.querySelector(".settings-popup"),i=document.getElementById("settings-close"),s=document.getElementById("accent-color"),n=document.querySelector(".settings-overlay"),r=document.querySelectorAll(".preset");i==null||i.addEventListener("click",()=>n==null?void 0:n.remove()),s==null||s.addEventListener("input",c=>{const o=c.target.value,a=e==null?void 0:e.querySelector(".color-picker-row span");a&&(a.textContent=o.toUpperCase()),t({accentColor:o})}),r.forEach(c=>{c.addEventListener("click",()=>{const o=c.dataset.color;s&&(s.value=o);const a=e==null?void 0:e.querySelector(".color-picker-row span");a&&(a.textContent=o.toUpperCase()),t({accentColor:o})})})}}const u="http://localhost:3000/api";class S{constructor(){h(this,"session",null);h(this,"settings",{accentColor:"#c9a227"});h(this,"sites",[]);h(this,"filteredSites",[]);h(this,"searchQuery","");h(this,"viewer",null);this.settings=v.load(),v.apply(this.settings),this.initCursorGlow(),this.checkSession()}async checkSession(){const t=localStorage.getItem("site-grid-session");if(t){try{this.session=JSON.parse(t);const e=await fetch(`${u}/sites`,{headers:{"X-Auth-Token":this.session.token}});if(e.ok){this.sites=await e.json(),this.filteredSites=[...this.sites],this.render();return}}catch{}this.session=null,localStorage.removeItem("site-grid-session")}this.renderLogin()}saveSession(){this.session?localStorage.setItem("site-grid-session",JSON.stringify(this.session)):localStorage.removeItem("site-grid-session")}initCursorGlow(){if(document.querySelector(".cursor-glow"))return;const e=document.createElement("div");e.className="cursor-glow",document.body.appendChild(e),document.addEventListener("mousemove",i=>{e.style.left=`${i.clientX}px`,e.style.top=`${i.clientY}px`})}filterSites(){if(!this.searchQuery)this.filteredSites=[...this.sites];else{const t=this.searchQuery.toLowerCase();this.filteredSites=this.sites.filter(e=>e.name.toLowerCase().includes(t))}}showSettings(){if(document.querySelector(".settings-overlay"))return;const e=document.createElement("div");e.className="settings-overlay",document.body.appendChild(e),e.innerHTML=v.render(this.settings),v.init(i=>{this.settings=i,v.save(i)}),e.addEventListener("click",i=>{i.target===e&&e.remove()})}renderLogin(){const t=document.getElementById("app");t.innerHTML=m.render(),m.init(this.handleLogin.bind(this))}async handleLogin(t){try{const e=await fetch(`${u}/auth/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:t})});if(!e.ok){const n=await e.json();throw new Error(n.error||"Login failed")}const i=await e.json();this.session={token:i.token,role:i.role},this.saveSession();const s=await fetch(`${u}/sites`,{headers:{"X-Auth-Token":this.session.token}});this.sites=await s.json(),this.filteredSites=[...this.sites],this.render()}catch(e){const i=document.querySelector(".login-error");i&&(i.textContent=e instanceof Error?e.message:"Access denied",i.classList.add("show"))}}async handleLogout(){this.session&&await fetch(`${u}/auth/logout`,{method:"POST",headers:{"X-Auth-Token":this.session.token}}),this.session=null,this.saveSession(),this.sites=[],this.filteredSites=[],this.renderLogin()}render(){var i,s;const t=document.getElementById("app"),e=((i=this.session)==null?void 0:i.role)==="admin";t.innerHTML=`
      <div class="app-container">
        ${L.render(((s=this.session)==null?void 0:s.role)||"guest",this.handleLogout.bind(this),this.showSettings.bind(this))}        
