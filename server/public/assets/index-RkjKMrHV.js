var S=Object.defineProperty;var $=(m,e,t)=>e in m?S(m,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):m[e]=t;var y=(m,e,t)=>$(m,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=t(i);fetch(i.href,n)}})();class k{static render(){return`
    ...
    `}}class w{static render(e,t=!1,s=[]){return e.length===0?`
      ...
      `:`<div class="site-grid">${e.map(n=>{const a=new Date(n.uploadedAt).toLocaleDateString("de-DE",{day:"2-digit",month:"short",year:"numeric"});return`
    ...
    `}}class B{static render(e,t,s,i,n,a,c,r,o){return`
      <header class="header">
    ...
    `}static init(e){const t=document.getElementById("login-username"),s=document.getElementById("login-password"),i=document.getElementById("btn-login"),n=i.querySelector(".btn-text"),a=document.getElementById("btn-toggle"),c=document.getElementById("toggle-text"),r=document.getElementById("login-error"),o=document.getElementById("login-card"),l=document.getElementById("card-glow");let u=!1;o==null||o.addEventListener("mousemove",g=>{if(!o||!l)return;const b=o.getBoundingClientRect(),f=g.clientX-b.left,x=g.clientY-b.top;l.style.background=`radial-gradient(circle at ${f}px ${x}px, var(--glow) 0%, transparent 50%)`,l.style.opacity="1"}),o==null||o.addEventListener("mouseleave",()=>{l&&(l.style.opacity="0")});const d=()=>{u=!u,u?(n.textContent="Create Account",c.textContent="Have an account?",a.textContent="Sign in"):(n.textContent="Sign In",c.textContent="New user?",a.textContent="Create account"),r.classList.remove("show")},v=async()=>{const g=t.value.trim(),b=s.value;if(!g){t.classList.add("shake"),r.textContent="Enter username",r.classList.add("show"),setTimeout(()=>t.classList.remove("shake"),400);return}if(!b){s.classList.add("shake"),r.textContent="Enter password",r.classList.add("show"),setTimeout(()=>s.classList.remove("shake"),400);return}i.classList.add("loading"),i.disabled=!0,r.classList.remove("show");try{await e(g,b,u)}catch(f){r.textContent=f instanceof Error?f.message:"Something went wrong",r.classList.add("show"),i.classList.remove("loading"),i.disabled=!1}};i==null||i.addEventListener("click",v),a==null||a.addEventListener("click",d),s==null||s.addEventListener("keydown",g=>{g.key==="Enter"&&v()}),t==null||t.addEventListener("input",()=>{r.classList.remove("show")}),setTimeout(()=>t==null?void 0:t.focus(),100)}}const L={accentColor:"#c9a227",gridSize:"normal"};class p{static load(){const e=localStorage.getItem("site-grid-settings");return e?{...L,...JSON.parse(e)}:{...L}}static save(e){localStorage.setItem("site-grid-settings",JSON.stringify(e)),this.apply(e)}static apply(e){const t=e.accentColor.replace("#",""),s=parseInt(t.slice(0,2),16),i=parseInt(t.slice(2,4),16),n=parseInt(t.slice(4,6),16);document.documentElement.style.setProperty("--accent",e.accentColor),document.documentElement.style.setProperty("--glow",`rgba(${s}, ${i}, ${n}, 0.4)`),document.documentElement.style.setProperty("--glow-warm",`rgba(${s}, ${i}, ${n}, 0.5)`);const a=Math.max(0,s-20),c=Math.max(0,i-30),r=Math.max(0,n-30);document.documentElement.style.setProperty("--accent-warm",`rgb(${a}, ${c}, ${r})`);const o=Math.max(0,s-80),l=Math.min(255,i+30),u=Math.min(255,n+30);document.documentElement.style.setProperty("--accent-sage",`rgb(${o}, ${l}, ${u})`),document.documentElement.style.setProperty("--bg-accent-tint",`rgba(${s}, ${i}, ${n}, 0.06)`),document.documentElement.style.setProperty("--glass-tint",`rgba(${s}, ${i}, ${n}, 0.12)`),document.documentElement.style.setProperty("--border-accent",`rgba(${s}, ${i}, ${n}, 0.4)`),document.documentElement.style.setProperty("--cursor-glow",`rgba(${s}, ${i}, ${n}, 0.4)`)}static render(e){return`
    ...
    `}static init(e){const t=document.querySelector(".settings-popup"),s=document.getElementById("settings-close"),i=document.getElementById("accent-color"),n=document.querySelector(".settings-overlay"),a=document.querySelectorAll(".preset"),c=document.querySelectorAll(".grid-option");s==null||s.addEventListener("click",()=>n==null?void 0:n.remove()),i==null||i.addEventListener("input",r=>{const o=r.target.value,l=t==null?void 0:t.querySelector(".color-picker-row span");l&&(l.textContent=o.toUpperCase());const u=p.load();e({...u,accentColor:o})}),a.forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.color;i&&(i.value=o);const l=t==null?void 0:t.querySelector(".color-picker-row span");l&&(l.textContent=o.toUpperCase());const u=p.load();e({...u,accentColor:o})})}),c.forEach(r=>{r.addEventListener("click",()=>{const o=r.dataset.size,l=p.load();e({...l,gridSize:o}),c.forEach(u=>u.classList.remove("active")),r.classList.add("active"),document.body.className=`grid-${o}`})})}}const h="http://localhost:3000/api";class M{constructor(){y(this,"session",null);y(this,"settings",{accentColor:"#c9a227",gridSize:"normal"});y(this,"sites",[]);y(this,"filteredSites",[]);y(this,"tags",[]);y(this,"searchQuery","");y(this,"viewer",null);this.settings=p.load(),p.apply(this.settings),this.initCursorGlow(),this.loadTags(),this.checkSession()}getAuthHeaders(){var e;return{Authorization:`Bearer ${((e=this.session)==null?void 0:e.token)??""}`,"Content-Type":"application/json"}}async apiRequest(e,t={}){const s=await fetch(e,{...t,headers:{...this.getAuthHeaders(),...t.headers}});if(!s.ok){const i=await s.json().catch(()=>({error:"Request failed"}));throw new Error(i.error||`HTTP ${s.status}`)}return s.json()}async checkSession(){const e=localStorage.getItem("site-grid-session");if(e)try{this.session=JSON.parse(e),await this.loadSites(),this.render();return}catch{}this.clearSession(),this.renderLogin()}clearSession(){this.session=null,localStorage.removeItem("site-grid-session")}initCursorGlow(){if(document.querySelector(".cursor-glow"))return;const e=document.createElement("div");e.className="cursor-glow",document.body.appendChild(e),document.addEventListener("mousemove",t=>{e.style.left=`${t.clientX}px`,e.style.top=`${t.clientY}px`})}async loadTags(){try{this.tags=await fetch(`${h}/api/tags`).then(e=>e.json())}catch{this.tags=[]}}async loadSites(){try{this.sites=await this.apiRequest(`${h}/api/sites`),this.filterSites()}catch{this.clearSession(),this.renderLogin()}}filterSites(){const e=this.searchQuery.toLowerCase();this.filteredSites=this.sites.filter(t=>{var s;return t.name.toLowerCase().includes(e)||((s=t.content)==null?void 0:s.toLowerCase().includes(e))})}createOverlay(e){const t=document.createElement("div");return t.className="settings-overlay",t.innerHTML=e,document.body.appendChild(t),t.addEventListener("click",s=>{s.target===t&&t.remove()}),t}showSettings(){var t;if(document.querySelector(".settings-overlay"))return;const e=this.createOverlay(p.render(this.settings));p.init(s=>{this.settings=s,p.save(s),p.apply(s)}),(t=document.getElementById("settings-close"))==null||t.addEventListener("click",()=>e.remove())}showLeaderboard(){var t;if(document.querySelector(".settings-overlay"))return;const e=this.createOverlay('<div class="settings-popup"><h3>Leaderboard</h3><div class="leaderboard-list" id="leaderboard-list"><div class="loading">Loading...</div></div><button class="settings-close" id="settings-close">Close</button></div>');(t=document.getElementById("settings-close"))==null||t.addEventListener("click",()=>e.remove()),fetch(`${h}/api/leaderboard`).then(s=>s.json()).then(s=>{const i=document.getElementById("leaderboard-list");i&&(i.innerHTML=s.length?s.map((n,a)=>`<div class="leaderboard-item ${a===0?"gold":a===1?"silver":a===2?"bronze":""}"><span class="rank">#${a+1}</span><span class="name">${n.username}</span><span class="visits">${n.visits} visits</span></div>`).join(""):'<div class="empty">No visits yet</div>')})}showUserManagement(){var t,s;if(((t=this.session)==null?void 0:t.role)!=="admin"||document.querySelector(".settings-overlay"))return;const e=this.createOverlay('<div class="settings-popup user-management"><h3>User Management</h3><div class="user-list" id="user-list"><div class="loading">Loading...</div></div><button class="settings-close" id="settings-close">Close</button></div>');(s=document.getElementById("settings-close"))==null||s.addEventListener("click",()=>e.remove()),this.loadUserList()}async loadUserList(){const e=document.getElementById("user-list");if(e)try{const t=await this.apiRequest(`${h}/api/admin/users`);e.innerHTML=t.map(s=>`<div class="user-item"><div class="user-info"><span class="user-name">${s.username}</span><span class="user-role ${s.role}">${s.role}</span></div><div class="user-stats">${s.visits} visits</div><div class="user-actions">${s.role!=="admin"?`<button class="user-btn promote" data-id="${s.id}">Promote</button>`:""}<button class="user-btn delete" data-id="${s.id}">Delete</button></div></div>`).join(""),e.querySelectorAll(".promote").forEach(s=>s.addEventListener("click",()=>void this.promoteUser(s.dataset.id))),e.querySelectorAll(".delete").forEach(s=>s.addEventListener("click",()=>void this.deleteUser(s.dataset.id)))}catch{e.innerHTML='<div class="error">Failed</div>'}}async promoteUser(e){if(confirm("Promote?"))try{await this.apiRequest(`${h}/api/admin/users/${e}`,{method:"PUT",body:JSON.stringify({role:"admin"})}),this.loadUserList()}catch(t){alert(t instanceof Error?t.message:"Error")}}async deleteUser(e){if(confirm("Delete?"))try{await this.apiRequest(`${h}/api/admin/users/${e}`,{method:"DELETE"}),this.loadUserList()}catch(t){alert(t instanceof Error?t.message:"Error")}}showTags(){var t,s,i;if(((t=this.session)==null?void 0:t.role)!=="admin"||document.querySelector(".settings-overlay"))return;const e=this.createOverlay('<div class="settings-popup"><h3>Manage Tags</h3><div class="tags-list" id="tags-list"></div><div class="add-tag"><input type="text" id="new-tag-name" placeholder="Tag name"><input type="color" id="new-tag-color" value="#c9a227"><button id="add-tag-btn">Add</button></div><button class="settings-close" id="settings-close">Close</button></div>');(s=document.getElementById("settings-close"))==null||s.addEventListener("click",()=>e.remove()),this.renderTags(),(i=document.getElementById("add-tag-btn"))==null||i.addEventListener("click",async()=>{var c,r;const n=(c=document.getElementById("new-tag-name"))==null?void 0:c.value,a=(r=document.getElementById("new-tag-color"))==null?void 0:r.value;n&&(await fetch(`${h}/api/tags`,{method:"POST",headers:this.getAuthHeaders(),body:JSON.stringify({name:n,color:a})}),this.tags=await fetch(`${h}/api/tags`).then(o=>o.json()),this.renderTags())})}async renderTags(){const e=document.getElementById("tags-list");e&&(e.innerHTML=this.tags.map(t=>`<div class="tag-item"><span class="tag-dot" style="background:${t.color}"></span><span>${t.name}</span><button class="tag-delete" data-id="${t.id}">X</button></div>`).join(""),e.querySelectorAll(".tag-delete").forEach(t=>t.addEventListener("click",async()=>{await fetch(`${h}/api/tags/${t.dataset.id}`,{method:"DELETE",headers:this.getAuthHeaders()}),this.tags=await fetch(`${h}/api/tags`).then(s=>s.json()),this.renderTags()})))}toggleGridSize(){const e=["small","normal","large"],t=e.indexOf(this.settings.gridSize||"normal");this.settings.gridSize=e[(t+1)%e.length],p.save(this.settings),document.body.className=`grid-${this.settings.gridSize}`}async exportZip(){window.open(`${h}/api/export`,"_blank")}escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}renderLogin(){const e=document.getElementById("app");e&&(e.innerHTML=E.render(),E.init(this.handleAuth.bind(this)))}async handleAuth(e,t,s){try{const i=await this.apiRequest(`${h}/api/auth/${s?"register":"login"}`,{method:"POST",body:JSON.stringify({username:e,password:t})});this.session={token:i.token,role:i.role,username:i.username,userId:i.id},localStorage.setItem("site-grid-session",JSON.stringify(this.session)),await this.loadSites(),await this.loadTags(),this.render()}catch(i){throw i}}async handleLogout(){this.clearSession(),this.sites=[],this.filteredSites=[],this.viewer=null,this.renderLogin()}render(){var t,s,i,n;const e=document.getElementById("app");e&&(document.body.className=`grid-${this.settings.gridSize||"normal"}`,e.innerHTML=`
    ...
    `,this.attachEventListeners(),this.loadSidebarData())}attachEventListeners(){var n,a,c,r,o,l,u;const e=document.getElementById("app");if(!e)return;(n=e.querySelector("#logout-btn"))==null||n.addEventListener("click",()=>this.handleLogout()),(a=e.querySelector("#settings-btn"))==null||a.addEventListener("click",()=>this.showSettings()),(c=e.querySelector("#leaderboard-btn"))==null||c.addEventListener("click",()=>this.showLeaderboard()),(r=e.querySelector("#users-btn"))==null||r.addEventListener("click",()=>this.showUserManagement()),(o=e.querySelector("#tags-btn"))==null||o.addEventListener("click",()=>this.showTags()),(l=e.querySelector("#export-btn"))==null||l.addEventListener("click",()=>this.exportZip());const t=e.querySelector(".search-input");t==null||t.addEventListener("input",d=>{this.searchQuery=d.target.value,this.filterSites(),this.updateGrid()}),e.querySelectorAll(".delete-btn").forEach(d=>d.addEventListener("click",v=>{var g;v.stopPropagation(),((g=this.session)==null?void 0:g.role)==="admin"&&this.handleDelete(d.dataset.id)})),e.querySelectorAll(".view-btn, .site-card").forEach(d=>d.addEventListener("click",()=>void this.handleView(d.dataset.id)));const s=e.querySelector("#file-input");s==null||s.addEventListener("change",async d=>{var g;const v=(g=d.target.files)==null?void 0:g[0];v&&(await this.handleUpload(v),s.value="")});const i=e.querySelector(".uploader");i==null||i.addEventListener("dragover",d=>{d.preventDefault(),i.classList.add("drag-over")}),i==null||i.addEventListener("dragleave",()=>i.classList.remove("drag-over")),i==null||i.addEventListener("drop",async d=>{var g;d.preventDefault(),i.classList.remove("drag-over");const v=(g=d.dataTransfer)==null?void 0:g.files[0];v&&await this.handleUpload(v)}),(u=e.querySelector("#back-btn"))==null||u.addEventListener("click",()=>{this.viewer=null,this.render()}),document.addEventListener("keydown",d=>{var v;d.target instanceof HTMLInputElement||(d.key==="/"&&(d.preventDefault(),t==null||t.focus()),(d.key==="n"||d.key==="N")&&(d.preventDefault(),(v=document.querySelector("#file-input"))==null||v.click()))})}async loadSidebarData(){try{const t=await fetch(`${h}/api/stats`).then(s=>s.json());document.getElementById("stat-logins").textContent=String(t.totalLogins),document.getElementById("stat-users").textContent=String(t.totalUsers),document.getElementById("stat-sites").textContent=String(t.totalSites)}catch{}const e=document.getElementById("sidebar-leaderboard");if(e)try{const t=await fetch(`${h}/api/leaderboard?limit=5`).then(s=>s.json());e.innerHTML=t.length?t.map((s,i)=>`<div class="sidebar-item ${i===0?"gold":i===1?"silver":i===2?"bronze":""}"><span class="sidebar-rank">${i+1}</span><span class="sidebar-name">${s.username}</span><span class="sidebar-visits">${s.visits}</span></div>`).join(""):'<div class="empty">No visits</div>'}catch{e.innerHTML='<div class="empty">Failed</div>'}}updateGrid(){var t;const e=document.querySelector(".grid-section");e&&(e.innerHTML=w.render(this.filteredSites,((t=this.session)==null?void 0:t.role)==="admin",this.tags),this.attachEventListeners())}async handleUpload(e){if(this.session)try{const t=await e.text();await this.apiRequest(`${h}/api/sites`,{method:"POST",body:JSON.stringify({name:e.name.replace(/\.(html?)$/i,""),content:t})}),await this.loadSites(),this.render()}catch(t){console.error(t),alert("Upload failed")}}async handleDelete(e){if(confirm("Delete?"))try{await this.apiRequest(`${h}/api/sites/${e}`,{method:"DELETE"}),this.sites=this.sites.filter(t=>t.id!==e),this.filterSites(),this.render()}catch(t){console.error(t)}}async handleView(e){if(this.session)try{const t=await this.apiRequest(`${h}/api/sites/${e}`);this.viewer=new C(t,()=>{this.viewer=null,this.render()}),this.viewer.open()}catch(t){console.error(t)}}}document.addEventListener("DOMContentLoaded",()=>new M);
