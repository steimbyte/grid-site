var w=Object.defineProperty;var f=(c,t,e)=>t in c?w(c,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):c[t]=e;var h=(c,t,e)=>f(c,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();class b{static render(){return`
    ...
    `}}class v{static render(t,e=!1){return t.length===0?`
        ...
        <div class="site-card" data-id="${s.id}">
          <div class="card-preview">
            <div class="card-placeholder">
              ...
              <span>${v.escapeHtml(s.name)}</span>
            </div>
          </div>
          <div class="card-info">
            <h3 class="card-title">${v.escapeHtml(s.name)}</h3>
    ...
    `}}class y{static render(){return`
      <div class="login-container">
        ...
        <div class="login-center">
          ...
          <button class="login-submit" id="btn-login">
            <span>Enter</span>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    `}static init(t){const e=document.getElementById("login-password"),i=document.getElementById("btn-login"),s=document.getElementById("login-error"),n=async()=>{const o=e.value.trim();if(!o){e.classList.add("error"),s.textContent="Password required",s.classList.add("show"),setTimeout(()=>e.classList.remove("error"),600);return}i.classList.add("loading"),s.classList.remove("show"),await t(o),i.classList.remove("loading")};i==null||i.addEventListener("click",n),e==null||e.addEventListener("keydown",o=>{o.key==="Enter"&&n(),e.classList.remove("error"),s.classList.remove("show")})}}const m={accentColor:"#c9a227"};class g{static load(){const t=localStorage.getItem("site-grid-settings");return t?{...m,...JSON.parse(t)}:{...m}}static save(t){localStorage.setItem("site-grid-settings",JSON.stringify(t)),this.apply(t)}static apply(t){const e=t.accentColor.replace("#",""),i=parseInt(e.slice(0,2),16),s=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);document.documentElement.style.setProperty("--accent",t.accentColor),document.documentElement.style.setProperty("--glow",`rgba(${i}, ${s}, ${n}, 0.4)`);const o=Math.min(255,i+30),d=Math.max(0,s-50),r=Math.max(0,n-30);document.documentElement.style.setProperty("--accent-warm",`rgb(${o}, ${d}, ${r})`);const a=Math.max(0,i-100),l=Math.min(255,s+40),p=Math.min(255,n+20);document.documentElement.style.setProperty("--accent-sage",`rgb(${a}, ${l}, ${p})`),document.documentElement.style.setProperty("--bg-accent-tint",`rgba(${i}, ${s}, ${n}, 0.05)`),document.documentElement.style.setProperty("--glass-tint",`rgba(${i}, ${s}, ${n}, 0.08)`),document.documentElement.style.setProperty("--border-accent",`rgba(${i}, ${s}, ${n}, 0.3)`)}static render(t){return`
