var w=Object.defineProperty;var f=(l,t,e)=>t in l?w(l,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[t]=e;var h=(l,t,e)=>f(l,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();class b{static render(){return`
      ...
      <div class="login-container">
        <div class="login-card">
          ...
          <div class="login-form">
            ...
            <button class="login-btn primary" id="btn-login">
              <span>Continue</span>
          ...
          <div class="quick-access">
            <button class="quick-btn" id="btn-guest">
              <span class="quick-label">Continue as</span>
              <span class="quick-role">Guest</span>
            </button>
          </div>
        </div>
      </div>
    `}static init(t){const e=document.getElementById("login-password"),i=document.getElementById("btn-login"),s=document.getElementById("btn-guest"),n=document.getElementById("login-error");setTimeout(()=>e==null?void 0:e.focus(),150);const r=async c=>{if(!c.trim()){n.textContent="Enter a password",n.classList.add("show"),e==null||e.classList.add("shake"),setTimeout(()=>e==null?void 0:e.classList.remove("shake"),400);return}i.classList.add("loading"),s.disabled=!0,n.classList.remove("show"),await t(c),i.classList.remove("loading"),s.disabled=!1};i==null||i.addEventListener("click",()=>r(e.value)),s==null||s.addEventListener("click",()=>r("guest")),e==null||e.addEventListener("keypress",c=>{c.key==="Enter"&&r(e.value)}),e==null||e.addEventListener("input",()=>{n.classList.contains("show")&&n.classList.remove("show")})}}const m={accentColor:"#c9a227"};class g{static load(){const t=localStorage.getItem("site-grid-settings");return t?{...m,...JSON.parse(t)}:{...m}}static save(t){localStorage.setItem("site-grid-settings",JSON.stringify(t)),this.apply(t)}static apply(t){const e=t.accentColor.replace("#",""),i=parseInt(e.slice(0,2),16),s=parseInt(e.slice(2,4),16),n=parseInt(e.slice(4,6),16);document.documentElement.style.setProperty("--accent",t.accentColor),document.documentElement.style.setProperty("--glow",`rgba(${i}, ${s}, ${n}, 0.4)`);const r=Math.min(255,i+30),c=Math.max(0,s-50),o=Math.max(0,n-30);document.documentElement.style.setProperty("--accent-warm",`rgb(${r}, ${c}, ${o})`);const a=Math.max(0,i-100),d=Math.min(255,s+40),p=Math.min(255,n+20);document.documentElement.style.setProperty("--accent-sage",`rgb(${a}, ${d}, ${p})`),document.documentElement.style.setProperty("--bg-accent-tint",`rgba(${i}, ${s}, ${n}, 0.05)`),document.documentElement.style.setProperty("--glass-tint",`rgba(${i}, ${s}, ${n}, 0.08)`),document.documentElement.style.setProperty("--border-accent",`rgba(${i}, ${s}, ${n}, 0.3)`)}static render(t){return`
