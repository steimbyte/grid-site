var x=Object.defineProperty;var S=(c,e,t)=>e in c?x(c,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):c[e]=t;var v=(c,e,t)=>S(c,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();class k{static render(){return`
    ...
    `}static init(e){const t=document.getElementById("login-username"),i=document.getElementById("login-password"),s=document.getElementById("btn-login"),r=document.getElementById("btn-toggle"),l=document.getElementById("toggle-text"),a=document.getElementById("login-error"),o=document.getElementById("login-card"),d=document.getElementById("card-glow");let n=!1;o==null||o.addEventListener("mousemove",m=>{if(!o||!d)return;const p=o.getBoundingClientRect(),f=m.clientX-p.left,E=m.clientY-p.top;d.style.background=`radial-gradient(circle at ${f}px ${E}px, var(--glow) 0%, transparent 50%)`,d.style.opacity="1"}),o==null||o.addEventListener("mouseleave",()=>{d&&(d.style.opacity="0")});const h=()=>{n=!n,n?(s.querySelector("span").textContent="Create Account",l.textContent="Have an account?",r.textContent="Sign in"):(s.querySelector("span").textContent="Sign In",l.textContent="New user?",r.textContent="Create account"),a.classList.remove("show")},u=async()=>{const m=t.value.trim(),p=i.value;if(!m){t.classList.add("shake"),a.textContent="Enter username",a.classList.add("show"),setTimeout(()=>t.classList.remove("shake"),400);return}if(!p){i.classList.add("shake"),a.textContent="Enter password",a.classList.add("show"),setTimeout(()=>i.classList.remove("shake"),400);return}s.classList.add("loading"),a.classList.remove("show");try{await e(m,p,n)}catch(f){a.textContent=f instanceof Error?f.message:"Something went wrong",a.classList.add("show")}s.classList.remove("loading")};s==null||s.addEventListener("click",u),r==null||r.addEventListener("click",h),i==null||i.addEventListener("keydown",m=>{m.key==="Enter"&&u()}),t==null||t.addEventListener("input",()=>{a.classList.remove("show")}),setTimeout(()=>t==null?void 0:t.focus(),100)}}const L={accentColor:"#c9a227"};class y{static load(){const e=localStorage.getItem("site-grid-settings");return e?{...L,...JSON.parse(e)}:{...L}}static save(e){localStorage.setItem("site-grid-settings",JSON.stringify(e)),this.apply(e)}static apply(e){const t=e.accentColor.replace("#",""),i=parseInt(t.slice(0,2),16),s=parseInt(t.slice(2,4),16),r=parseInt(t.slice(4,6),16);document.documentElement.style.setProperty("--accent",e.accentColor),document.documentElement.style.setProperty("--glow",`rgba(${i}, ${s}, ${r}, 0.4)`);const l=Math.min(255,i+30),a=Math.max(0,s-50),o=Math.max(0,r-30);document.documentElement.style.setProperty("--accent-warm",`rgb(${l}, ${a}, ${o})`);const d=Math.max(0,i-100),n=Math.min(255,s+40),h=Math.min(255,r+20);document.documentElement.style.setProperty("--accent-sage",`rgb(${d}, ${n}, ${h})`),document.documentElement.style.setProperty("--bg-accent-tint",`rgba(${i}, ${s}, ${r}, 0.05)`),document.documentElement.style.setProperty("--glass-tint",`rgba(${i}, ${s}, ${r}, 0.08)`),document.documentElement.style.setProperty("--border-accent",`rgba(${i}, ${s}, ${r}, 0.3)`)}static render(e){return`
