var $=Object.defineProperty;var k=(m,e,t)=>e in m?$(m,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):m[e]=t;var b=(m,e,t)=>k(m,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();class C{static render(){return`
    ...
    `}static escapeHtml(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}}class q{constructor(e,t){b(this,"site");b(this,"onClose");this.site=e,this.onClose=t}open(){var a;const e=document.querySelector(".app-container");if(!e)return;const t=document.createElement("div");t.className="viewer-overlay",t.innerHTML=this.render(),e.appendChild(t),window.lucide&&window.lucide.createIcons();const i=document.getElementById("site-iframe"),s=document.getElementById("iframe-loader");if(i&&this.site.content){i.onload=()=>{s==null||s.classList.add("hidden"),i.classList.add("loaded");try{const r=i.contentDocument;r&&(r.documentElement.style.backgroundColor="#0a0a0f",r.body.style.backgroundColor="#0a0a0f")}catch{}};const n=getComputedStyle(document.documentElement).getPropertyValue("--bg-deep")||"#0a0a0f",h=getComputedStyle(document.documentElement).getPropertyValue("--accent")||"#c9a227",d=getComputedStyle(document.documentElement).getPropertyValue("--border-accent")||"#333";i.srcdoc=`<html><body style="background:${n};margin:0;display:flex;align-items:center;justify-content:center;height:100vh;">
    ...
    `}}class x{static render(e,t,i,s,a,n,h,d,r,l){return`
      <header class="header">
    ...
    `}}class S{static render(){return`
      <div class="login-bg">
        <div class="shader-bg">
          <div class="shader-streaks">
            <div class="shader-streak"></div>
            <div class="shader-streak"></div>
            <div class="shader-streak"></div>
            <div class="shader-streak"></div>
            <div class="shader-streak"></div>
    ...
    `}static init(e){const t=document.getElementById("login-username"),i=document.getElementById("login-password"),s=document.getElementById("btn-login"),a=s.querySelector(".btn-text"),n=document.getElementById("btn-toggle"),h=document.getElementById("toggle-text"),d=document.getElementById("login-error"),r=document.getElementById("login-card"),l=document.getElementById("card-glow");let g=!1;r==null||r.addEventListener("mousemove",p=>{if(!r||!l)return;const o=r.getBoundingClientRect(),c=p.clientX-o.left,f=p.clientY-o.top;l.style.background=`radial-gradient(circle at ${c}px ${f}px, var(--glow) 0%, transparent 50%)`,l.style.opacity="1"}),r==null||r.addEventListener("mouseleave",()=>{l&&(l.style.opacity="0")});const v=()=>{g=!g,g?(a.textContent="Create Account",h.textContent="Have an account?",n.textContent="Sign in"):(a.textContent="Sign In",h.textContent="New user?",n.textContent="Create account"),d.classList.remove("show")},w=async()=>{const p=t.value.trim(),o=i.value;if(!p){t.classList.add("shake"),d.textContent="Enter username",d.classList.add("show"),setTimeout(()=>t.classList.remove("shake"),400);return}if(!o){i.classList.add("shake"),d.textContent="Enter password",d.classList.add("show"),setTimeout(()=>i.classList.remove("shake"),400);return}s.classList.add("loading"),s.disabled=!0,d.classList.remove("show");try{await e(p,o,g)}catch(c){d.textContent=c instanceof Error?c.message:"Something went wrong",d.classList.add("show"),s.classList.remove("loading"),s.disabled=!1}};s==null||s.addEventListener("click",w),n==null||n.addEventListener("click",v),i==null||i.addEventListener("keydown",p=>{p.key==="Enter"&&w()}),t==null||t.addEventListener("input",()=>{d.classList.remove("show")}),setTimeout(()=>t==null?void 0:t.focus(),100)}}const L={accentColor:"#c9a227",gridSize:"normal"};class y{static load(){const e=localStorage.getItem("site-grid-settings");return e?{...L,...JSON.parse(e)}:{...L}}static save(e){localStorage.setItem("site-grid-settings",JSON.stringify(e)),this.apply(e)}static apply(e){const t=e.accentColor.replace("#",""),i=parseInt(t.slice(0,2),16),s=parseInt(t.slice(2,4),16),a=parseInt(t.slice(4,6),16);document.documentElement.style.setProperty("--accent",e.accentColor),document.documentElement.style.setProperty("--glow",`rgba(${i}, ${s}, ${a}, 0.4)`),document.documentElement.style.setProperty("--glow-warm",`rgba(${i}, ${s}, ${a}, 0.5)`);const n=Math.max(0,i-20),h=Math.max(0,s-30),d=Math.max(0,a-30);document.documentElement.style.setProperty("--accent-warm",`rgb(${n}, ${h}, ${d})`);const r=Math.max(0,i-80),l=Math.min(255,s+30),g=Math.min(255,a+30);document.documentElement.style.setProperty("--accent-sage",`rgb(${r}, ${l}, ${g})`),document.documentElement.style.setProperty("--bg-accent-tint",`rgba(${i}, ${s}, ${a}, 0.06)`),document.documentElement.style.setProperty("--glass-tint",`rgba(${i}, ${s}, ${a}, 0.12)`),document.documentElement.style.setProperty("--border-accent",`rgba(${i}, ${s}, ${a}, 0.4)`),document.documentElement.style.setProperty("--cursor-glow",`rgba(${i}, ${s}, ${a}, 0.4)`)}static render(e){return`
    ...
    `}static init(e){const t=document.querySelector(".settings-popup"),i=document.getElementById("settings-close"),s=document.getElementById("accent-color"),a=document.querySelector(".settings-overlay"),n=document.querySelectorAll(".preset"),h=document.querySelectorAll(".grid-option");i==null||i.addEventListener("click",()=>a==null?void 0:a.remove()),s==null||s.addEventListener("input",d=>{const r=d.target.value,l=t==null?void 0:t.querySelector(".color-picker-row span");l&&(l.textContent=r.toUpperCase());const g=y.load();e({...g,accentColor:r})}),n.forEach(d=>{d.addEventListener("click",()=>{const r=d.dataset.color;s&&(s.value=r);const l=t==null?void 0:t.querySelector(".color-picker-row span");l&&(l.textContent=r.toUpperCase());const g=y.load();e({...g,accentColor:r})})}),h.forEach(d=>{d.addEventListener("click",()=>{const r=d.dataset.size,l=y.load();e({...l,gridSize:r}),h.forEach(g=>g.classList.remove("active")),d.classList.add("active"),document.body.className=`grid-${r}`})})}}let u="http://localhost:3000/api";class I{constructor(){b(this,"session",null);b(this,"settings",{accentColor:"#c9a227",gridSize:"normal"});b(this,"sites",[]);b(this,"filteredSites",[]);b(this,"tags",[]);b(this,"searchQuery","");b(this,"viewer",null);this.settings=y.load(),y.apply(this.settings),this.initCursorGlow(),this.initApiUrl()}async initApiUrl(){try{const t=await(await fetch("/api/config")).json();t.frontendUrl&&(u=`${t.frontendUrl.replace(/\/$/,"")}/api`)}catch{}this.loadTags(),await this.checkSession()}getAuthHeaders(){var e;return{Authorization:`Bearer ${((e=this.session)==null?void 0:e.token)??""}`,"Content-Type":"application/json"}}async apiRequest(e,t={}){const i=await fetch(e,{...t,headers:{...this.getAuthHeaders(),...t.headers}});if(!i.ok){const s=await i.json().catch(()=>({error:"Request failed"}));throw new Error(s.error||`HTTP ${i.status}`)}return i.json()}async checkSession(){const e=localStorage.getItem("site-grid-session");if(e)try{this.session=JSON.parse(e),await this.loadSites(),this.render();return}catch{}this.clearSession(),this.renderLogin()}clearSession(){this.session=null,localStorage.removeItem("site-grid-session")}initCursorGlow(){if(document.querySelector(".cursor-glow"))return;const e=document.createElement("div");e.className="cursor-glow",document.body.appendChild(e),document.addEventListener("mousemove",t=>{e.style.left=`${t.clientX}px`,e.style.top=`${t.clientY}px`})}async loadTags(){try{this.tags=await fetch(`${u}/tags`).then(e=>e.json())}catch{this.tags=[]}}async loadSites(){try{this.sites=await this.apiRequest(`${u}/sites`),this.filterSites()}catch{this.clearSession(),this.renderLogin()}}filterSites(){const e=this.searchQuery.toLowerCase();this.filteredSites=this.sites.filter(t=>{var i;return t.name.toLowerCase().includes(e)||((i=t.content)==null?void 0:i.toLowerCase().includes(e))})}createOverlay(e){const t=document.createElement("div");return t.className="settings-overlay",t.innerHTML=e,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.remove()}),t}showSettings(){var t;if(document.querySelector(".settings-overlay"))return;const e=this.createOverlay(y.render(this.settings));y.init(i=>{this.settings=i,y.save(i),y.apply(i)}),(t=document.getElementById("settings-close"))==null||t.addEventListener("click",()=>e.remove())}showLeaderboard(){var t;if(document.querySelector(".settings-overlay"))return;const e=this.createOverlay('<div class="settings-popup"><h3>Leaderboard</h3><div class="leaderboard-list" id="leaderboard-list"><div class="loading">Loading...</div></div><button class="settings-close" id="settings-close">Close</button></div>');(t=document.getElementById("settings-close"))==null||t.addEventListener("click",()=>e.remove()),this.apiRequest(`${u}/leaderboard`).then(i=>{const s=document.getElementById("leaderboard-list");s&&(s.innerHTML=i.length?i.map((a,n)=>`<div class="leaderboard-item ${n===0?"gold":n===1?"silver":n===2?"bronze":""}"><span class="rank">#${n+1}</span><span class="name">${a.username}</span><span class="visits">${a.visits} visits</span></div>`).join(""):'<div class="empty">No visits yet</div>')}).catch(()=>{const i=document.getElementById("leaderboard-list");i&&(i.innerHTML='<div class="empty">Failed to load</div>')})}showUserManagement(){var t,i;if(((t=this.session)==null?void 0:t.role)!=="admin"||document.querySelector(".settings-overlay"))return;const e=this.createOverlay('<div class="settings-popup user-management"><h3>User Management</h3><div class="user-list" id="user-list"><div class="loading">Loading...</div></div><button class="settings-close" id="settings-close">Close</button></div>');(i=document.getElementById("settings-close"))==null||i.addEventListener("click",()=>e.remove()),this.loadUserList()}async loadUserList(){const e=document.getElementById("user-list");if(e)try{const[t,i]=await Promise.all([this.apiRequest(`${u}/admin/users`),this.apiRequest(`${u}/settings`)]);e.innerHTML=t.map(s=>{var a;return`
      ...
      <div class="app-container">
        ${x.render(((t=this.session)==null?void 0:t.role)??"user",((i=this.session)==null?void 0:i.username)??"User",this.handleLogout.bind(this),this.showSettings.bind(this),this.showLeaderboard.bind(this),((s=this.session)==null?void 0:s.role)==="admin"?this.showUserManagement.bind(this):void 0,this.toggleGridSize.bind(this),this.showTags.bind(this),this.exportZip.bind(this),this.showSiteSettings.bind(this))}
    ...
    `,document.body.appendChild(i);let s=[];try{const g=(await(await fetch("https://cdn.jsdelivr.net/npm/lucide@latest/dist/esm/lucide.js")).text()).matchAll(/export \{ default as ([A-Z][a-zA-Z]+)/g);for(const v of g){const p=v[1].replace(/([A-Z])/g,"-$1").toLowerCase().replace(/^-/,"");s.push(p)}}catch{s=["globe","file","image","code","link","star","heart"]}const a=document.getElementById("icon-grid"),n=document.getElementById("icon-search"),h=r=>{var g;const l=r?s.filter(v=>v.toLowerCase().includes(r.toLowerCase())):s.slice(0,200);a.innerHTML=l.slice(0,80).map(v=>`<button class="icon-option ${t.icon===v?"selected":""}" data-icon="${v}" title="${v}">
          <i data-lucide="${v}"></i>
        </button>`).join(""),(g=window.lucide)==null||g.createIcons()};h(""),a.addEventListener("click",async r=>{const l=r.target.closest(".icon-option");if(!l)return;const g=l.dataset.icon;try{await this.apiRequest(`${u}/sites/${e}`,{method:"PUT",body:JSON.stringify({icon:g})}),await this.loadSites(),this.render(),i.remove()}catch{alert("Icon update failed")}}),n.addEventListener("input",()=>h(n.value)),(d=document.getElementById("settings-close"))==null||d.addEventListener("click",()=>i.remove()),i.addEventListener("click",r=>{r.target===i&&i.remove()})}async handleView(e){if(this.session)try{const t=await this.apiRequest(`${u}/sites/${e}`);this.viewer=new q(t,()=>{this.viewer=null,this.render()}),this.viewer.open()}catch(t){console.error(t)}}}document.addEventListener("DOMContentLoaded",()=>new I);
